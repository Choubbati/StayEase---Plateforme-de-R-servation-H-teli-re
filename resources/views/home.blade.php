...
<body class="bg-gray-50 text-gray-900">
    ...
    <nav class="flex justify-between items-center px-10 py-6 bg-white shadow-sm">
        <div class="text-2xl font-bold text-indigo-600 tracking-tight">StayEase</div>
        <div class="hidden md:flex gap-8 font-medium text-gray-600">
            <a href="#" class="hover:text-indigo-600 transition">Hôtels</a>
        ...
        <div class="flex gap-4">
            ...
            <button class="px-5 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition">S'inscrire</button>
        </div>
    </nav>
    ...
    <section class="max-w-7xl mx-auto px-10 py-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-100">
                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=600" class="h-56 w-full object-cover">
                <div class="p-6">
                    <span class="text-indigo-600 font-bold text-sm uppercase">Paris</span>
                    <h3 class="text-xl font-bold mt-2">Hôtel Lumière</h3>
                    <p class="text-gray-500 mt-2 text-sm italic">Un séjour inoubliable au pied de la Tour Eiffel.</p>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-100">
                <img src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&q=80&w=600" class="h-56 w-full object-cover">
                <div class="p-6">
                    ...
                    <div class="mt-6 flex justify-between items-center">
                        <span class="text-2xl font-bold">220€<span class="text-sm text-gray-400 font-normal">/nuit</span></span>
                        <button class="text-indigo-600 font-bold hover:underline">Voir l'offre</button>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition border border-gray-100">
                <img src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&q=80&w=600" class="h-56 w-full object-cover">
                <div class="p-6">
                    <span class="text-indigo-600 font-bold text-sm uppercase">New York</span>
                    <h3 class="text-xl font-bold mt-2">Skyline Suites</h3>
                    <p class="text-gray-500 mt-2 text-sm italic">Une vue imprenable sur Central Park.</p>
                    <div class="mt-6 flex justify-between items-center">
                        <span class="text-2xl font-bold">310€<span class="text-sm text-gray-400 font-normal">/nuit</span></span>
                        <button class="text-indigo-600 font-bold hover:underline">Voir l'offre</button>
                    </div>
                </div>
            </div>
