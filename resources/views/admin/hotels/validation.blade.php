...
<head>
    ...
    <title>StayEase | Validation des Hôtels</title>
        ...
        <aside class="w-72 bg-white border-r border-slate-200 hidden lg:flex flex-col">
            ...
            <nav class="flex-1 px-4 space-y-1">
                ...
                <a href="{{ route('admin.hotels.validation') }}"
                    class="flex items-center justify-between px-4 py-3 bg-indigo-50 text-indigo-700 rounded-xl transition group font-bold">
                    <div class="flex items-center gap-3">
